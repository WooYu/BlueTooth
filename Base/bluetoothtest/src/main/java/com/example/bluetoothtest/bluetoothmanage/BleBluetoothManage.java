...
import com.example.bluetoothtest.bean.ParseLeAdvData;
import com.example.bluetoothtest.callback.IDataCallback;
import com.example.bluetoothtest.callback.IScanCallback;
import com.example.bluetoothtest.service.BluetoothLeService;
...
public class BleBluetoothManage {
    ...
    public static final int SERVICE_CALLBACK = 0x00;
    public static final int SERVICE_CONNECT_SUCCEED = 0x01;
    public static final int SERVICE_CONNECT_FAIL = 0x02;
    public static final int SERVICE_ERROR_DISCONNECT = 0x03;
    public static final int SERVICE_SEND_DATA_NUMBER = 0x04;
    public static final int SERVICE_READ_LOG = 0x05;
